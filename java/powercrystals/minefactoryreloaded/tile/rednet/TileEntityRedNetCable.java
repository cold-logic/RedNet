...
public class TileEntityRedNetCable extends TileEntity implements INeighboorUpdateTile
{
	...
	public RedNetConnectionType getConnectionState(ForgeDirection side) {
		...
		Block myBlock = worldObj.getBlock(bp.x, bp.y, bp.z);
		int blockId = Block.getIdFromBlock(myBlock);
...
//		else if(blockId == MineFactoryReloadedCore.rednetCableBlock.blockID) 
		else if(myBlock == MineFactoryReloadedCore.rednetCableBlock) 
		{
...
//		else if(b.isBlockSolid(worldObj, bp.x, bp.y, bp.z, side.getOpposite()))
		else if(b.isBlockSolid(worldObj, bp.x, bp.y, bp.y, side.getOpposite().flag))
		{
...
//	@Override
//	public RedNetCablePacket getDescriptionPacket()
//	{
...
//		return new RedNetCablePacket(MineFactoryReloadedCore.modNetworkChannel, 11, xCoord, yCoord, zCoord, _sideColors[0], _sideColors[1], _sideColors[2], _sideColors[3], _sideColors[4], _sideColors[5], _mode);
//	}
